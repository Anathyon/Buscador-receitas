...
const RecipeFilters: React.FC<RecipeFiltersProps> = ({ onFilter }) => {
  ...
  return (
    <div className="bg-white rounded-xl max-w-4xl flex flex-col justify-center shadow-xl"
     style={{padding:"1.5rem", marginInline:"auto", marginBlock:"2rem"}}>
      <div style={{marginBottom:"2rem"}}>
        <h2 className="text-xl font-bold text-gray-800 flex justify-center items-center"
